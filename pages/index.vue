  ...
  <div>
    ...
    <main class="container">
      ...
      <section class="metrics">
        <card-metrics
          :data="data"
          v-for="(data, index) in cardMetrics"
          :key="index"
        />
        <!-- <card-metrics :data="cardMetrics" />
        <card-metrics :data="cardMetrics" /> -->
      </section>
      ...
      <section class="orders">
        <div class="filter-bar">
          <div class="filters">
            <app-filter-tag text="All Time" />
            <app-filter-tag text="US, AU, +4" />
