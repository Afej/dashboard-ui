  ...
  <header>
    <div class="header-content container">
      <div class="logo">
        ...
        >
          <g filter="url(#filter0_dd_1509_1693)">
            <rect
              x="3.15"
              y="2.15"
              width="31.7"
            ...
            <rect
              ...
              height="31.7"
              rx="7.85"
              fill="url(#paint0_linear_1509_1693)"
            />
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
            ...
            <path
              ...
              fill="#D0D5DD"
            />
            <g filter="url(#filter1_dd_1509_1693)">
              <circle
                cx="19"
                cy="18"
                r="8"
                fill="url(#paint1_linear_1509_1693)"
              />
            </g>
            <g filter="url(#filter2_b_1509_1693)">
              <path
          ...
          <defs>
            ...
            >
              ...
              <feBlend
                ...
                result="effect1_dropShadow_1509_1693"
              />
              <feColorMatrix
                in="SourceAlpha"
                type="matrix"
              ...
              <feBlend
                mode="normal"
                in2="effect1_dropShadow_1509_1693"
                result="effect2_dropShadow_1509_1693"
              />
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect2_dropShadow_1509_1693"
                result="shape"
              />
            </filter>
            <filter
              id="filter1_dd_1509_1693"
              x="8"
              y="8"
              width="22"
              height="22"
            ...
            >
              ...
              <feComposite
                in2="SourceAlpha"
                operator="in"
                result="effect1_backgroundBlur_1509_1693"
              />
              <feBlend
                mode="normal"
                in="SourceGraphic"
                in2="effect1_backgroundBlur_1509_1693"
                result="shape"
              />
            </filter>
            <linearGradient
              id="paint0_linear_1509_1693"
              x1="19"
              y1="2"
              x2="19"
              y2="34"
        ...
        <span class="logo-title">Untitled UI</span>
      </div>
